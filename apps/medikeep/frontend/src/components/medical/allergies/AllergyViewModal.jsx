                    ...
                    <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
                      <Stack gap="xs">
                        <Text fw={500} size="sm" c="dimmed">
                          {t('allergies.allergen.label')}
                        </Text>
                        <Text size="sm">{allergy.allergen}</Text>
                      </Stack>
                      <Stack gap="xs">
                        <Text fw={500} size="sm" c="dimmed">
                          {t('allergies.allergyType.label')}
                        </Text>
                        <Text
                          size="sm"
                          c={allergy.allergy_type ? 'inherit' : 'dimmed'}
                        >
                          {allergy.allergy_type ||
                ...
                <Stack gap="lg">
                  <div>
                    ...
                    <SimpleGrid cols={{ base: 1, sm: 2 }} spacing="md">
                      <Stack gap="xs">
                        <Text fw={500} size="sm" c="dimmed">
                          {t('allergies.reactionType.label')}
                        </Text>
                        <Text
                          size="sm"
                          c={allergy.reaction_type ? 'inherit' : 'dimmed'}
                        >
